export default {
  ...
  pricing: {
    title: 'Preise',
    subtitle: 'Unsere Preise sind modular aufgebaut – bezahlen Sie nur für die Services, die Sie benötigen.',
    services: {
      analysis: {
        name: 'Analysieren',
      ...
      verification: {
        ...
        description: 'Qualitätssicherung durch manuelle Prüfung',
        unit: 'Seite',
        prefix: 'ab',
      },
      scanning: {
      ...
      extras: {
        name: 'Extraservices',
        description: 'Datenbearbeitung, API-Integration, etc.',
        price: 'Auf Anfrage',
      },
    },
    volumeDiscount: {
  ...
  calculator: {
    ...
    pagesLabel: 'Anzahl Seiten',
    services: {
      analysis: 'Analysieren',
      verification: 'Durch Menschen verifizieren',
      scanning: 'Scannen',
    },
    costBreakdown: {
      analysis: 'Analyse',
  ...
  problemStatement: {
    ...
    subtitle: 'Viele Unternehmen stehen vor den gleichen Herausforderungen:',
    painPoints: {
      volume: {
  ...
  efficiencyComparison: {
    title: 'Effizienzvergleich: Manuell vs. Automatisiert',
    subtitle: 'Professionelle Automatisierung optimiert Ihre Prozesse messbar.',
    manual: {
  ...
  services: {
    ...
    subtitle: 'Wir bieten flexible Lösungen für jeden Bedarf - von Selbstbedienung bis zur maßgeschneiderten Enterprise-Lösung.',
    popular: 'Beliebt',
    fullService: {
      title: 'Full Service',
  ...
  contact: {
    ...
    trustSignals: {
      ...
      confidential: 'Vertraulich behandelt',
    },
  },

  footerContent: {
    description: 'Handschriftliche Formulare in strukturierte Daten konvertieren.',
    sections: {
      services: 'Services',
    ...
    trust: {
      ...
      responseTime: '24h',
      responseTimeSubtext: 'Antwortzeit',
    },
    legal: {
      privacy: 'Datenschutz',
      imprint: 'Impressum',
